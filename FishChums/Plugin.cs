...
namespace FishChums
{
    ...
    public class FishChumsPlugin : BaseUnityPlugin
    {
        ...
        public static readonly ManualLogSource FishChumsLogger =
        ...
        public void Awake()
        {
            ...
            ItemManager.PrefabManager.RegisterPrefab(PrefabManager.RegisterAssetBundle("fishingbaitbundle"), "leviathanChumSpawner", false); 
